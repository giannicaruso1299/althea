        ...
        <div className="justify-content-center">
            <div className="row">
                <div className="col-xl-4 col-12 text-center d-sm-block d-none">
                    ...
                    <a href="http://www.laminierabomboniere.it/" target="_blank"><img src={require("../img/laminiera.png")} alt="La Miniera bomboniere" className="laminiera d-xl-inline d-none"></img></a>
                    <a href="http://www.dolcicosebomboniere.com/" target="_blank"><img src={require("../img/dolcicose.png")} alt="Dolci Cose bomboniere" className="mt-3 d-xl-inline d-none"></img></a>
                    <a href="http://www.ctfbomboniere.com/" target="_blank"><img src={require("../img/ctf.png")} id="ctf" className="ml-3 mt-2 d-xl-inline d-none"></img></a>
                </div>
                ...
                <div className="col-xl-4 col-12 pt-xl-6 text-center seguicisu">
