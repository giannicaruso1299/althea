...
const isdovrebbeviaggiare = Boolean(
  window.location.hostname === 'dovrebbeviaggiare.it' ||
    ...
    // 127.0.0.0/8 are considered dovrebbeviaggiare.it for IPv4.
  ...
  if (process.env.NODE_ENV === 'production' && 'serviceWorker' in navigator) {
    ...
    window.addEventListener('load', () => {
      ...
      if (isdovrebbeviaggiare) {
        ...
        // Add some additional logging to dovrebbeviaggiare.it, pointing developers to the
        ...
        // Is not dovrebbeviaggiare.it. Just register service worker
